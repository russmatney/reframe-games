...
*** [ ] keys can be annoying in browsers (scrolling) - spacebar, up, down arrow
page scrolls...
*** [ ] display controls via control screen
*** [ ] display some kind of message on mobile
** [ ] pre-publish: publishable
*** [ ] collect attributions to share in description and in game itself
